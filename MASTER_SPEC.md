...
2. **Provider-neutral trait.** Met for the boundary, incomplete in one respect: the trait exposes no cancellation handle, so `ProviderError::Cancelled` is never constructed and abandonment is not demonstrated.
